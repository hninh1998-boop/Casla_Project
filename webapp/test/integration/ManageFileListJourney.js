...
sap.ui.define([
    ...
    function journey() {
        ...
        //     When.onTheManageFileList.onFilterBar().iChangeSearchField("Search Term");
        ...
        opaTest("Check table columns and actions", function (Given, When, Then) {
            Then.onTheManageFileList.onTable().iCheckCreate({ visible: true });
            // Then.ontheManageFileList.onTable().iPressCreate();
