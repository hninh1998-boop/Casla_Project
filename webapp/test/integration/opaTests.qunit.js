...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "zuploadzbomrp/test/integration/FirstJourney",
    "zuploadzbomrp/test/integration/ManageFileListJourney",
    "zuploadzbomrp/test/integration/ManageFileObjectPageJourney",
    "zuploadzbomrp/test/integration/DataFileObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
