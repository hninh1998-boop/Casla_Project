...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "zcrudpocov4/test/integration/FirstJourney",
    "zcrudpocov4/test/integration/ManageFileListJourney",
    "zcrudpocov4/test/integration/ManageFileObjectPageJourney",
    "zcrudpocov4/test/integration/DataFileObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
