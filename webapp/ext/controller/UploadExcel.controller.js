sap.ui.define([
    ...
    return ControllerExtension.extend('zudbank.ext.controller.UploadExcel', {

        // ===== Constants ==========================================================
        // Action uploadExcel bound to Collection (ZC_TBBANK_UPL)
        // → path: /ZC_TBBANK_UPL/<NS>uploadExcel(...)
        _NS: "com.sap.gateway.srvd.zui_tbbank_upl_o4.v0001.",
        _ENTITY_SET: "ZC_TBBANK_UPL",
        _DIALOG_ID: "idFileUploadDialog",
        _FRAGMENT: "zudbank.ext.fragment.filedialog",
        ...
        override: {
             ...
             * @memberOf zudbank.ext.controller.UploadExcel
             */
            onInit: function () {
        ...
        // ===== Button handler (declared in manifest.json) ========================
