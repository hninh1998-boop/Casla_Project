sap.ui.define([
	...
	return {
		 ...
		 *    Parameters: companycode, mainasset, subasset (Edm.String)
		...
		btnPrintPDF: function () {
			...
			aRows.forEach(function (o) {
				...
				if (o.mainasset) { aMain.push(o.mainasset); }
				if (o.subasset !== undefined && o.subasset !== null) { aSub.push(String(o.subasset)); }
			});
