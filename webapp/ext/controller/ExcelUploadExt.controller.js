sap.ui.define([
	...
	return ControllerExtension.extend("zextmatass.ext.controller.ExcelUploadExt", {
		downloadTemplate: async function () {
			...
			const oCols = [
				{ label: "Group", property: "Group", type: "string" },
				{ label: "Group Counter", property: "GroupCounter", type: "string" },
		...
		_NS: "com.sap.gateway.srvd.zui_upload_mat_ass.v0001.",
		_ENTITY_SET: "ManageFile",
		_DIALOG_ID: "idFileUploadDialog",
		_FRAGMENT: "zextmatass.ext.fragment.filedialog",
		...
		override: {
			...
			editFlow: {
				onAfterActionExecution: function (oEvent) {
					// oEvent là string dạng: "com.sap.gateway.srvd.zui_upload_mat_ass.v0001.downloadTemplate(...)"
