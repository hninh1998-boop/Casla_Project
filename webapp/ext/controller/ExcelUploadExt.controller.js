sap.ui.define(['sap/ui/core/mvc/ControllerExtension',
	...
	function (ControllerExtension, Spreadsheet, MessageBox, MessageToast) {
		...
		return ControllerExtension.extend('zextendmaterial.ext.controller.ExcelUploadExt', {
			...
			override: {
				...
				onInit: function () {
					...
					this.oServicePath = "/ExtendProduct/com.sap.gateway.srvd.zui_extend_mat.v0001.";
				},
				editFlow: {
			...
			uploadexceldialog: function () {
				...
				if (!this.oDialog) {
					this.oDialog = sap.ui.core.Fragment.load({
						id: oView.getId(),
						controller: this,
						name: "zextendmaterial.ext.fragment.filedialog"
