sap.ui.define(['sap/ui/core/mvc/ControllerExtension',
	...
	function (ControllerExtension, Spreadsheet, MessageBox, MessageToast) {
		...
		return ControllerExtension.extend('zextendewmprod.ext.controller.ExcelUploadExt', {
			...
			override: {
				...
				*/
				onInit: function () {
					...
					this.oServicePath = "/ExtendEWMProduct/com.sap.gateway.srvd.zui_extend_ewm_prod.v0001.";
				},
				editFlow: {
			...
			downloadTemplate: function (oDownload) {
				...
				var oCol = [
					{ label: "Product Number", property: "ProductNumber", type: "string" },
					{ label: "Warehouse Number", property: "WarehouseNumber", type: "string" },
					{ label: "Plant", property: "Plant", type: "string" },
					{ label: "Storage Type", property: "StorageType", type: "string" }
				];
			...
			uploadexceldialog: function () {
				...
				if (!this.oDialog) {
					this.oDialog = sap.ui.core.Fragment.load({
						id: oView.getId(),
						controller: this,
						name: "zextendewmprod.ext.fragment.filedialog"
