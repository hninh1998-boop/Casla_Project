sap.ui.define(['sap/ui/core/mvc/ControllerExtension',
	...
	function (ControllerExtension, Spreadsheet, MessageBox, MessageToast) {
		...
		return ControllerExtension.extend('zbp.ext.controller.ExcelUploadExt', {
			// this section allows to extend lifecycle hooks or hooks provided by Fiori elements
			override: {
				/**
				 * Called when a controller is instantiated and its View controls (if available) are already created.
				 * Can be used to modify the View before it is displayed, to bind event handlers and do other one-time initialization.
				 * @memberOf zbp.ext.controller.ExcelUploadExt
				 */
				onInit: function () {
					// you can access the Fiori elements extensionAPI via this.base.getExtensionAPI
					var oModel = this.base.getExtensionAPI().getModel();
					this.oServicePath = "/Bp/com.sap.gateway.srvd.zui_bp.v0001.";
				}
			},
			uploadexceldialog: function () {
				...
				if (!this.oDialog) {
					this.oDialog = sap.ui.core.Fragment.load({
						id: oView.getId(),
						controller: this,
						name: "zbp.ext.fragment.filedialog"
